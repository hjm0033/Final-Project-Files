...
DD=/scratch/$MyID/DogBrainProjectTemp/RawData                          ## Example: DD=/scratch/$MyID/PracticeRNAseq/RawData
...
### Must move paired end reads into RawData directory before executing.
